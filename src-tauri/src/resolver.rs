...
mod tests {
    ...
    fn fixture() -> Vec<WfcdItem> {
        ...
        vec![
            ...
            mk(
                "Arcane Energize",
                "/Lotus/Types/Game/ZarimanPistolArcane",
                "Arcanes",
            ),
        ]
    }
    ...
    fn slug_derives_from_canonical_display_name() {
        ...
        for item in fixture() {
            let resolved = r
                .by_unique(&item.unique_name)
                .expect("fixture item is indexed");
    ...
    fn known_items_keep_their_slugs() {
        ...
        assert_eq!(
            r.by_display("Arcane Energize").unwrap().slug,
            "arcane_energize"
        );
    }
    ...
    fn slug_variants_adds_and_strips_blueprint_suffix() {
        ...
        assert_eq!(
            slug_variants("serration"),
            ["serration", "serration_blueprint"]
        );
    }
}
